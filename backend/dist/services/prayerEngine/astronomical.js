 ...
 */
export function calculateSolarCoordinates(julianDay) {
 ...
 */
export function calculateSolarTransitHours(longitude, timezoneOffsetHours, equationOfTimeMinutes) {
 ...
 */
export function calculateHourAngle(altitudeDeg, latitudeDeg, declinationRad) {
 ...
 */
export function calculateAsrAltitudeDeg(shadowMultiplier, latitudeDeg, declinationDeg) {
