 ...
 */
export function gregorianToHijri(gregorianDate, adjustmentDays = 0) {
    ...
    // Match event
    const matchedEvent = ISLAMIC_EVENTS.find((e) => e.hijriMonth === month && e.hijriDay === day);
 ...
 */
export function getMonthlyCalendarGrid(gregorianYear, gregorianMonth, // 1 - 12
adjustmentDays = 0) {
