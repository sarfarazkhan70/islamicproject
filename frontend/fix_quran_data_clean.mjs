...
const SURAH_PHYSICAL_PAGES = [
  3, 4, 92, 144, 197, 240, 280, 329, 349, 386,       // 1-10
 ...
 * Mushaf PDF Mapping for Zia-ul-Quran / Subcontinent 9-Line Mushaf (1124 pages total, 2 initial cover pages, 1122 Quran text pages)
 */
...
// Complete 114 Surahs Directory (Page 1 of Text = Physical PDF Page 3)
export const SURAHS_LIST: SurahMeta[] = ${JSON.stringify(surahs, null, 2)};

// 30 Paras / Juz Directory (Page 1 of Text = Physical PDF Page 3)
export const JUZ_LIST: JuzMeta[] = ${JSON.stringify(juzs, null, 2)};

export const TOTAL_MUSHAF_PDF_PAGES = 1122;
...
console.log('Regenerated src/data/quranData.ts cleanly!');
