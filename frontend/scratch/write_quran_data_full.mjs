...
export interface QuranReciterOption {
  ...
  name: string;
  style?: string;
  reciterSlug: string; // for ayah-by-ayah audio
}
...
// 30 Juz Index with verified Zia-ul-Quran 9-line Mushaf PDF page starts (1-1124)
...
fs.writeFileSync('src/data/quranData.ts', code);
console.log('Successfully wrote src/data/quranData.ts');
