...
async function main() {
  await createHeaderMontage([195, 196, 197, 198, 199, 200, 201, 202], './scripts/jild3_page_200.png', 'Jild 3: Scans around 200');
  await createHeaderMontage([295, 296, 297, 298, 299, 300, 301, 302], './scripts/jild3_page_300.png', 'Jild 3: Scans around 300');
}
