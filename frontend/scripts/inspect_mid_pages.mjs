...
async function createHeaderMontage(volNum, pages, outPath, title) {
  const images = [];
  for (const p of pages) {
    const imgPath = `./public/sharah-muslim/jild-${volNum}/page_${p}.webp`;
...
async function main() {
  await createHeaderMontage(6, [395, 396, 397, 398, 399, 400], './scripts/jild6_page_400.png', 'Jild 6: Scans around 400');
  await createHeaderMontage(7, [195, 196, 197, 198, 199, 200], './scripts/jild7_page_200.png', 'Jild 7: Scans around 200');
}
