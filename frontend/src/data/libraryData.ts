...
export const ISLAMIC_BOOKS: IslamicBook[] = [
  ...
  },
  {
    ...
    source: 'Verified Classical Musnad Standard Edition',
    volumes: [
      { id: 'muslim-vol-1', volumeNumber: 1, title: 'Jild 1: Book of Faith & Purification', urduTitle: 'جلد ۱ (کتاب الایمان وطہارت)', isAvailable: true, chaptersCount: 8 },
      { id: 'muslim-vol-2', volumeNumber: 2, title: 'Jild 2: Prayer (Salah) & Mosques', urduTitle: 'جلد ۲ (کتاب الصلاۃ ومساجد)', isAvailable: true, chaptersCount: 10 },
      { id: 'muslim-vol-3', volumeNumber: 3, title: 'Jild 3: Zakat, Fasting & I’tikaf', urduTitle: 'جلد ۳ (کتاب الزکاۃ والصوم والاعتکاف)', isAvailable: true, chaptersCount: 8 },
      { id: 'muslim-vol-4', volumeNumber: 4, title: 'Jild 4: Hajj, Marriage & Sucking', urduTitle: 'جلد ۴ (کتاب الحج والنکاح والرضاع)', isAvailable: true, chaptersCount: 9 },
      { id: 'muslim-vol-5', volumeNumber: 5, title: 'Jild 5: Business, Judicial Rulings & Oaths', urduTitle: 'جلد ۵ (کتاب البیوع والاقضیۃ والایمان)', isAvailable: true, chaptersCount: 11 },
      { id: 'muslim-vol-6', volumeNumber: 6, title: 'Jild 6: Virtues of Companions, Destiny & Dhikr', urduTitle: 'جلد ۶ (کتاب الفضائل والقدر والذکر)', isAvailable: true, chaptersCount: 12 },
    ],
  },
  {
    id: 'jami-at-tirmidhi',
